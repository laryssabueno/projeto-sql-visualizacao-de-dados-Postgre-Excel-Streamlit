...
dash_sales = st.Page("C:/Users/Laryssa Bueno/OneDrive/Curso Udemy SQL/Projeto SQL - Midori/Dashboards/1_Leads.py", title = "Vendas", icon= "💰")
dash_leads = st.Page("C:/Users/Laryssa Bueno/OneDrive/Curso Udemy SQL/Projeto SQL - Midori/Dashboards/2_Clients.py", title = "Perfil Leads", icon= "👤")
query_vendas = st.Page("C:/Users/Laryssa Bueno/OneDrive/Curso Udemy SQL/Projeto SQL - Midori/Dados e Querys/1_Vendas.py", title = "Dataframe e Queries Vendas", icon= "📓")
query_clientes = st.Page("C:/Users/Laryssa Bueno/OneDrive/Curso Udemy SQL/Projeto SQL - Midori/Dados e Querys/2_Clientes.py", title = "Dataframe e Queries Leads", icon= "🗄")
